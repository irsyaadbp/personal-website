---
title: "React Documentation Translation – Referencing Values with Refs"
description: "Translated the React useRef documentation section into Indonesian for the React Indonesia community."
client: "React Indonesia Documentation"
role: "Translator (Open Source)"
year: "2023"
...
The translated section is now available at [Referencing Values with Refs – Indonesian version](https://id.react.dev/learn/referencing-values-with-refs).

## Contribution & Process

- Opened [Issue #387](https://github.com/reactjs/id.react.dev/issues/387) on the `reactjs/id.react.dev` repository to highlight that Referencing Values with Refs had not yet been translated.
- Submitted [Pull Request #479](https://github.com/reactjs/id.react.dev/pull/479) containing the full translation of the `referencing-values-with-refs.md` file, including sections such as adding a ref, stopwatch example, differences between refs and state, and best practices.
- Improved wording consistency (e.g., "menggunakan" vs "dengan"), refined grammar, and polished technical terms (mutable, render, snapshot) for clarity.
