  ...
  en: [
    {
      ...
      companyLogo: "/assets/images/company/sekolahmu.svg",
      period: "Sept 2025 - Present",
      location: "Remote",
      description:
        "Indonesia-based edtech platform for upskilling and learning.",
      bullets: [
        "Led development of a website customization feature that reduced engineering effort for new product page creation by ~85%, accelerating go-to-market speed.",
        "Applied dynamic imports to optimize bundle splitting, reducing unused JavaScript delivery by ~40% and improving initial load performance.",
      ],
    },
    {
      ...
      companyLogo: "/assets/images/company/privy.svg",
      period: "Feb 2023 - June 2025",
      location: "Yogyakarta, Indonesia",
      description:
        "Indonesia's leading digital signature & identity verification platform.",
      bullets: [
    ...
    },
    {
      ...
      company: "Arkademy (now Pijarcamp)",
      companyUrl: "https://camp.pijarmahir.id/",
      companyLogo: "/assets/images/company/pijar.svg",
      period: "March 2021 - June 2021",
      location: "Remote",
      description:
        "Edtech startup providing coding bootcamps for career switchers in Indonesia.",
      bullets: [
    ...
    },
    {
      ...
      companyLogo: "/assets/images/company/virus.jpg",
      companyLogoRounded: true,
      period: "December 2019 - December 2020",
      location: "Bogor, Indonesia",
      description:
        "Tech consulting firm providing custom ERP and digital solutions to SMEs.",
      bullets: [
    ...
    },
    {
      ...
      companyLogo: "/assets/images/company/quick.jpg",
      companyLogoRounded: true,
      period: "July 2019 - August 2019",
      location: "Yogyakarta, Indonesia",
      description:
        "One of Indonesia's oldest manufacturing companies specializing in agricultural machinery.",
      bullets: [
    ...
    },
    {
      ...
      description:
        "One of Indonesia's oldest manufacturing companies specializing in agricultural machinery.",
      bullets: [
        "Assisted in building and maintaining internal tooling and mobile apps.",
      ],
    },
  ],
  id: [
    {
      ...
      location: "Remote",
      description:
        "Platform edtech berbasis di Indonesia untuk upskilling dan pembelajaran.",
      bullets: [
        "Memimpin pengembangan fitur kustomisasi website yang mengurangi upaya engineering untuk pembuatan halaman produk baru hingga ~85%, mempercepat go-to-market.",
        "Menerapkan dynamic import untuk mengoptimalkan bundle splitting, memangkas pengiriman JavaScript yang tidak terpakai hingga ~40% dan meningkatkan performa initial load.",
      ],
    },
    {
      role: "Mid. Frontend Engineer",
      ...
      location: "Yogyakarta, Indonesia",
      description:
        "Platform tanda tangan digital & verifikasi identitas terdepan di Indonesia.",
      bullets: [
    ...
    {
      role: "Technical Trainer",
      company: "Arkademy (sekarang Pijarcamp)",
      companyUrl: "https://camp.pijarmahir.id/",
      companyLogo: "/assets/images/company/pijar.svg",
      period: "Maret 2021 - Juni 2021",
      location: "Remote",
      description:
        "Startup edtech yang menyediakan bootcamp coding untuk career switcher di Indonesia.",
      bullets: [
    ...
    },
    {
      ...
      location: "Bogor, Indonesia",
      description:
        "Konsultan teknologi yang menyediakan solusi ERP dan digital untuk UKM.",
      bullets: [
    ...
    },
    {
      ...
      location: "Yogyakarta, Indonesia",
      description:
        "Salah satu perusahaan manufaktur tertua di Indonesia yang berfokus pada mesin pertanian.",
      bullets: [
    ...
    },
    {
      ...
      description:
        "Salah satu perusahaan manufaktur tertua di Indonesia yang berfokus pada mesin pertanian.",
      bullets: [
        "Membantu membangun dan memelihara tooling internal serta aplikasi mobile.",
      ],
    },
  ],
};
